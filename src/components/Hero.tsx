...
//                   </div>
//                   <div>
//                     <p className="text-sm font-medium text-muted-foreground">Current Course</p>
//                     <p className="text-base font-bold text-foreground">Advanced Web Development</p>
//                   </div>
//                   <div className="ml-auto">
//                     <span className="text-xs font-bold bg-primary/10 text-primary px-2 py-1 rounded-full">In Progress</span>
//                   </div>
//                 </div>
//               </div> 
//             </div>
