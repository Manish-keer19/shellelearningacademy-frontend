  ...
  return (
    <footer className="border-t border-border bg-background">
      <div className="container mx-auto px-4 py-8 sm:py-10 lg:py-12">
        ...
        {/* Newsletter Section */}
        <div className="mt-6 sm:mt-8 rounded-lg border border-border bg-muted/30 p-4 sm:p-6">
          <div className="flex flex-col items-center justify-between gap-3 sm:gap-4 sm:flex-row">
            ...
            <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
              <input
                ...
                className="rounded-md border border-border bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary w-full sm:w-auto"
              />
