...
// --- MAIN FORM ---
const CourseSignUpForm: React.FC<CourseSignUpFormProps> = ({
  courseName,
  courseId,
  onSuccess,
}) => {
    ...
    console.log("Course ID:", actualCourseId);
    console.log("Course Name:", actualCourseName);
  ...
  const handleSignup = async (data: EnrollmentFormFields) => {
    ...
    // Add contactNumber field to match backend requirements
    const formData = {
      ...data,
      contactNumber: data.contactNo // Backend expects both contactNumber and contactNo
    };
    ...
    try {
      ...
      if (token && user) {
        ...
        console.log("Token saved in localStorage:", localStorage.getItem("EnrollMentToken"));
        
        toast.success("Thanks you can enrolle the course")
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-12">
            <div className="flex justify-center mb-6">
              <img src={logo} alt="Shell E-learning Academy" className="h-20 w-20 object-contain" />
            </div>
            <h1 className="text-4xl md:text-5xl font-extrabold text-foreground mb-4">
              Join <span className="text-primary">Shell E-learning Academy</span>
            </h1>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Start your learning journey with industry-leading courses and expert mentorship
            </p>
            {courseName && (
              <div className="mt-4 inline-block bg-primary/10 text-primary px-4 py-2 rounded-full font-semibold">
                Enrolling for: {courseName}
              </div>
            )}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          >
            ...
            <motion.button
              ...
              className={`w-full h-12 flex items-center justify-center rounded-xl font-semibold text-primary-foreground text-base transition-all duration-300 shadow-lg
                ${
                  isSubmitting
