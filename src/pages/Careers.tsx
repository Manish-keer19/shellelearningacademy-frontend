          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="flex-1 space-y-8 text-center lg:text-left">
              ...
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Join our innovative team and shape the future of learning with us. We're looking for passionate individuals to make a difference.
              </p>
            ...
            <div className="flex-1 relative w-full max-w-lg lg:max-w-xl">
              ...
              <div className="absolute top-10 -left-10 bg-white p-4 rounded-2xl shadow-xl border border-green-50 animate-bounce-slow hidden md:block">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground font-bold uppercase tracking-wider">Active Applicants</p>
                    <p className="text-lg font-extrabold text-foreground">2,400+</p>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute bottom-20 -right-8 bg-white p-4 rounded-2xl shadow-xl border border-green-50 animate-pulse-slow hidden md:block">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-xs text-muted-foreground font-bold uppercase tracking-wider">Jobs Posted</p>
              ...
              <div className="absolute -bottom-6 left-12 bg-white p-3 rounded-xl shadow-lg border border-green-50 flex items-center gap-2 animate-float hidden md:flex">
                ...
                <span className="font-bold text-sm text-green-800">Interview Scheduled</span>
              </div>
            </div>
          </div>
        </div>
          ...
          {isLoading ? (
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {filteredJobs.map((job: any) => (
                <Card
                  key={job._id}
                  className="group bg-white border-green-100 hover:border-green-300 shadow-sm hover:shadow-xl transition-all duration-300 rounded-[24px] overflow-hidden flex flex-col relative"
                >
                  {/* Lightning Icon */}
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <Badge variant="outline" className="rounded-full px-3 py-1 border-gray-200 text-gray-500 font-mono text-xs">
                        #{job._id.slice(-4)}
                      </Badge>
                    </div>

                    <Badge className={`w-fit mb-2 rounded-lg px-2.5 py-0.5 text-xs font-bold ${getJobTypeColor(job.jobType)}`}>
                      {job.jobType}
                    </Badge>
                  ...
                  <CardContent className="flex-grow space-y-4">
                    <div className="flex flex-wrap gap-3 text-sm text-muted-foreground">
                      <div className="flex items-center gap-1.5 bg-secondary/30 px-2.5 py-1.5 rounded-md">
                        {job.location === 'Remote' ? <Globe className="w-4 h-4 text-blue-500" /> : <MapPin className="w-4 h-4 text-red-500" />}
      ...
      <div className="py-24 bg-[#f0fdf4] overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-16">
            Skilled, Trained, Project-Ready Talent. Our graduates are equipped with the latest industry skills.
          </p>
          ...
          <div className="relative h-[400px] max-w-4xl mx-auto flex items-center justify-center">
            ...
            <div className="absolute top-0 left-1/4 animate-float">
              <img src={student1} className="w-16 h-16 rounded-full border-4 border-white shadow-lg" alt="Student" />
            </div>
            <div className="absolute bottom-10 right-1/4 animate-float" style={{ animationDelay: '1s' }}>
              <img src={student2} className="w-20 h-20 rounded-full border-4 border-white shadow-lg" alt="Student" />
            </div>
            <div className="absolute top-10 right-10 animate-float" style={{ animationDelay: '2s' }}>
              <img src={student3} className="w-14 h-14 rounded-full border-4 border-white shadow-lg" alt="Student" />
            </div>
            <div className="absolute bottom-0 left-10 animate-float" style={{ animationDelay: '1.5s' }}>
              <img src={student4} className="w-16 h-16 rounded-full border-4 border-white shadow-lg" alt="Student" />
            </div>
            <div className="absolute top-1/2 left-0 -translate-y-1/2 animate-float" style={{ animationDelay: '0.5s' }}>
              <img src={student5} className="w-12 h-12 rounded-full border-4 border-white shadow-lg" alt="Student" />
            </div>
            <div className="absolute top-1/2 right-0 -translate-y-1/2 animate-float" style={{ animationDelay: '2.5s' }}>
              <img src={student6} className="w-14 h-14 rounded-full border-4 border-white shadow-lg" alt="Student" />
            </div>
          </div>
        </div>
      </div>
