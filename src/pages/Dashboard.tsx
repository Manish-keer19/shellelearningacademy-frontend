...
import { BookOpen, Award, Clock, TrendingUp, GraduationCap, Play, Settings, Users, CheckCircle, Search, Loader2, Zap, Calendar, Sparkles, UserPlus, FileCheck, Image as ImageIcon } from "lucide-react";
...
const Dashboard = () => {
    ...
    const adminActions = [
        ...
        { title: "Hero Images", description: "Upload & manage hero section slider images.", icon: ImageIcon, action: () => navigate('/admin/hero-images'), colorClass: "from-sky-500 to-blue-600" },
