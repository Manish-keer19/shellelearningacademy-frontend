...
const CourseDetail = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/10">
                ...
                <Card className="p-6">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 gap-4">
                    <div className="flex-1">
                      <h3 className="text-2xl font-bold mb-2 flex items-center gap-2">
                        ...
                        Course Materials & Brochures
                      </h3>
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        Access downloadable resources, guides, and brochures designed to support your learning journey. All materials are optimized for quick access and offline use.
                      </p>
                    </div>
                    <Button 
                      onClick={() => handleDownloadBrochure({} as Brochure, true)}
                      disabled={isDownloading}
                      className="bg-primary hover:bg-primary/90 text-white flex items-center gap-2 shadow-lg hover:shadow-primary/20 transition-all duration-300"
                      size="lg"
                    >
                      {isDownloading ? (
                      ...
                      >
                        ...
                        <div className="aspect-[4/3] relative overflow-hidden bg-gradient-to-br from-primary/5 to-secondary/5 group-hover:from-primary/10 group-hover:to-secondary/10 transition-all duration-500">
                          ...
                          <div className="absolute top-3 left-3 z-10">
                            <Badge className="bg-primary/90 text-white border-0 shadow-md backdrop-blur-sm">
                              Material #{index + 1}
                            </Badge>
                          </div>
                          ...
                          <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 bg-black/20 backdrop-blur-sm">
                            <div className="bg-white/95 backdrop-blur-md rounded-full p-4 shadow-2xl border border-white/20 transform scale-95 group-hover:scale-100 transition-transform duration-300">
                        ...
                        <div className="p-6 relative z-10">
                          <div className="flex items-start justify-between mb-3">
                            <h4 className="font-bold text-lg leading-tight line-clamp-1 text-foreground group-hover:text-primary transition-colors duration-300 pr-2">
                              {brochure.name}
                            </h4>
                          ...
                          <p className="text-sm text-muted-foreground mb-4 line-clamp-2 leading-relaxed group-hover:line-clamp-none transition-all duration-300">
                            {brochure.description}
                          </p>
                          
                          {/* Action Buttons - Stacked for Better UX */}
                          <div className="flex flex-col sm:flex-row gap-2 pt-2">
                            <Button 
                              ...
                              className="flex-1 flex items-center justify-center gap-2 hover:bg-primary hover:text-white hover:border-primary transition-all duration-300 shadow-sm hover:shadow-md"
                            >
                              <Eye className="w-4 h-4" />
                              Preview
                            </Button>
                            <Button 
                              ...
                              disabled={isDownloading}
                              className="flex-1 bg-primary hover:bg-primary/90 text-white flex items-center justify-center gap-2 shadow-sm hover:shadow-md transition-all duration-300"
                            >
                              {isDownloading ? (
                                <Loader2 className="w-4 h-4 animate-spin" />
                              ) : (
                  ...
                  {brochures.length === 0 && (
                    <div className="text-center py-12">
                      ...
                      <h4 className="text-lg font-semibold mb-2">No Materials Available</h4>
                      <p className="text-muted-foreground">Check back later for updated course resources.</p>
                    </div>
                  )}
                </Card>
              </TabsContent>
              ...
              <TabsContent value="instructor" className="mt-6">
                <Card className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold text-lg">{course.instructor?.fullName}</p>
                      <p className="text-sm text-muted-foreground">Course Instructor</p>
                    </div>
                  </div>
                </Card>
            ...
            <Card className="p-6 sticky top-24">
              ...
              <div className="space-y-3 max-h-80 overflow-y-auto">
                {brochures.slice(0, 3).map((brochure) => (
                  <div 
                    key={brochure.id} 
                    className="flex items-center justify-between p-3 rounded-xl hover:bg-muted/50 transition-all duration-300 group cursor-pointer border border-border/50 hover:border-primary/30"
                    onClick={() => setPreviewBrochure(brochure)}
                  >
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      <div 
                        className="w-10 h-10 rounded-lg overflow-hidden bg-muted group-hover:bg-primary/10 transition-colors flex-shrink-0 relative"
                        onClick={(e) => {
                          e.stopPropagation();
                          setPreviewBrochure(brochure);
                        }}
                      ...
                      <div className="min-w-0 flex-1">
                        <p className="font-medium text-sm truncate group-hover:text-primary transition-colors">{brochure.name}</p>
                        <p className="text-xs text-muted-foreground line-clamp-1">{brochure.description}</p>
                      </div>
                    </div>
                    <div className="flex gap-1 ml-2 flex-shrink-0">
                      <Button 
                        ...
                        className="h-8 w-8 p-0 hover:bg-primary hover:text-white transition-all"
      ...
      <Dialog open={!!previewBrochure} onOpenChange={() => setPreviewBrochure(null)}>
        <DialogContent className="max-w-6xl max-h-[95vh] p-0 border-0 shadow-2xl rounded-2xl overflow-hidden">
          {previewBrochure && (
            <div className="relative bg-white flex flex-col h-full">
              {/* Header with Enhanced Design */}
              <div className="flex items-center justify-between p-6 border-b bg-gradient-to-r from-primary/5 via-background to-secondary/5 backdrop-blur-sm sticky top-0 z-10">
                <div className="flex items-center gap-4 flex-1 min-w-0">
                  <div className="w-14 h-14 rounded-xl overflow-hidden bg-white shadow-lg border border-white/20">
                    <img 
                      src={previewBrochure.imageUrl} 
                      alt={previewBrochure.name}
                      className="w-full h-full object-cover"
                  ...
                  <div className="min-w-0 flex-1">
                    <h3 className="text-xl font-bold text-foreground truncate">{previewBrochure.name}</h3>
                    <p className="text-sm text-muted-foreground line-clamp-2 leading-relaxed">{previewBrochure.description}</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  <Button 
                  ...
                  <Button 
                    ...
                    disabled={isDownloading}
                    className="bg-primary hover:bg-primary/90 text-white flex items-center gap-2 shadow-lg hover:shadow-primary/20 transition-all"
                    size="sm"
                  >
                    {isDownloading ? (
                      <Loader2 className="w-4 h-4 animate-spin" />
              ...
              <div className="flex-1 overflow-hidden relative">
                <div className="p-6 max-h-full overflow-auto bg-gradient-to-b from-gray-50/50 to-white/50">
                  ...
                  <div className="mt-6 text-center">
                    <p className="text-sm text-muted-foreground italic">
                      Tip: Zoom in for details or download for full access.
                    </p>
                  </div>
                </div>
              </div>
