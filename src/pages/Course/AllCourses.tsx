...
// 4. Mobile Filter Drawer Component
const MobileFilterDrawer = ({
    isOpen,
    onClose,
    children,
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            >
             ...
             {/* CHANGE 1: Replaced max-w-7xl with max-w-screen-2xl to allow the container to be wider.
             */}
            <main className="container mx-auto px-4 pt-20 pb-20 max-w-screen-2xl">
                ...
                <div className="flex flex-col lg:flex-row gap-10">
                    ...
                    <div className="lg:w-3/4 w-full">
                        ...
                        {/* Content Display */}
                        {isLoading ? (
                             /* CHANGE 2: Added 2xl:grid-cols-4 to show four cards per row on very large screens.
                             */
